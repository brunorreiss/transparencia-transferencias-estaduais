...
logger_name = env.get('BOT_NAME', default='transparencia-tranferencias-estaduais')
...
tags_metadata = [
    {
        'name': 'transparencia-tranferencias-estaduais',
        'description': 'Consulta Portal Tranparencia Fortaleza - principais transferencias estaduais'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - principais transferencias estaduais', 
    description=desc, 
    debug=False, 
    openapi_tags=tags_metadata,
    openapi_url="/api/transparencia-tranferencias-estaduais/consulta/docs/openapi.json",
    docs_url='/api/transparencia-tranferencias-estaduais/consulta/docs'
)
...
#---------------------------- Endpoints -------------------------------
@app.get(
    path="/api/transparencia-tranferencias-estaduais/consulta", 
    tags=['transparencia-tranferencias-estaduais'],
    responses=responses)
